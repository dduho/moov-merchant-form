    ...
    <div class="container">
        ...
        <div class="content">
            ...
            @else
                ...
                <p>Pas d'inquiétude ! Vous pouvez modifier et resoumettre votre candidature en suivant le lien ci-dessous.</p>
            @endif
            ...
            @else
                <a href="{{ config('app.frontend_url') }}/applications/{{ $application->id }}/edit" class="button">
