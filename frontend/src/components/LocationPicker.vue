<template>
  <div class="space-y-4">
    ...
    <details class="border border-gray-200 dark:border-gray-600 rounded-xl" open>
      <summary class="p-4 cursor-pointer text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">
        <i class="fas fa-pencil-alt mr-2 text-orange-500"></i>
        Saisie manuelle des coordonnées
      </summary>
      <div class="p-4 border-t border-gray-200 dark:border-gray-600 space-y-4">
