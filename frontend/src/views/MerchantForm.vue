                    ...
                    <div class="form-group relative">
                      ...
                      <div class="relative">
                        <input 
                          ...
                          @compositionstart="filterBirthPlaces()"
                          @compositionupdate="filterBirthPlaces()"
                    ...
                    <div class="form-group relative">
                      ...
                      <div class="relative">
                        <input 
                          ...
                          @compositionstart="filterNationalities()"
                          @compositionupdate="filterNationalities()"
                    ...
                    <div class="form-group">
                      ...
                      <div class="relative">
                        <input 
                          ...
                          @input="filterCities()"
                          @keyup="filterCities()"
                          @compositionstart="filterCities()"
                          @compositionupdate="filterCities()"
